/*  This program is a test for generating memes.
...
const os = require('os');
const im = require('../lib/im') // Comment this line if using Windows
// const im = require('../lib/im7') // Uncomment this line for ImageMagick 7 and Windows usage (see https://www.imagemagick.org/Usage/windows/#convert_issue)
const fs = require('fs')
